...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_C_3A_5CUsers_5Cwildan_5CDocuments_5CWeb_20Project_5Clioke_rebrand_matchers_W3sicmVnZXhwIjoiXig_2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2NsaWVudHpvbmUoPzpcXC8oKD86W15cXC8jXFw_2FXSs_2FKSg_2FOlxcLyg_2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik_2FW1xcLyNcXD9dPyQifV0_3D_)
});
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.js&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5Cwildan%5CDocuments%5CWeb%20Project%5Clioke-rebrand&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2NsaWVudHpvbmUoPzpcXC8oKD86W15cXC8jXFw%2FXSs%2FKSg%2FOlxcLyg%2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik%2FW1xcLyNcXD9dPyQifV0%3D!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_C_3A_5CUsers_5Cwildan_5CDocuments_5CWeb_20Project_5Clioke_rebrand_matchers_W3sicmVnZXhwIjoiXig_2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2NsaWVudHpvbmUoPzpcXC8oKD86W15cXC8jXFw_2FXSs_2FKSg_2FOlxcLyg_2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik_2FW1xcLyNcXD9dPyQifV0_3D_(opts) {
          return adapter({
              ...opts,
              page: "/middleware",
              handler,
...
function middleware(request) {
    if (request.nextUrl.pathname === "/clientzone") {
        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect(new URL("/clientzone/dashboard", request.url));
    }
}
const config = {
    matcher: [
...
var _addPathPrefix = __webpack_require__(407);
var _pathHasPrefix = __webpack_require__(763);
function addLocale(path, locale, defaultLocale, ignorePrefix) {
...
var _parsePath = __webpack_require__(774);
function addPathPrefix(path, prefix) {
    if (!path.startsWith("/") || !prefix) {
        return path;
    }
...
var _removeTrailingSlash = __webpack_require__(712);
var _addPathPrefix = __webpack_require__(407);
var _addPathSuffix = __webpack_require__(551);
var _addLocale = __webpack_require__(435);
function formatNextPathnameInfo(info) {
...
var _normalizeLocalePath = __webpack_require__(199);
var _removePathPrefix = __webpack_require__(226);
var _pathHasPrefix = __webpack_require__(763);
function getNextPathnameInfo(pathname, options) {
    var _nextConfig;
    const { basePath , i18n , trailingSlash  } = (_nextConfig = options.nextConfig) != null ? _nextConfig : {};
...
var _detectDomainLocale = __webpack_require__(824);
var _formatNextPathnameInfo = __webpack_require__(718);
var _getHostname = __webpack_require__(502);
var _getNextPathnameInfo = __webpack_require__(674);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|::1|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
var _responseCookies = __webpack_require__(863);
...
var _uaParserJs = _interopRequireDefault(__webpack_require__(830));
