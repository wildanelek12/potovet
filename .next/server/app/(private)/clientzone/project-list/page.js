...
function Page() {
    ...
    const [year, setYear] = (0,react_.useState)(optionYears[0]);
    const [month, setMonth] = (0,react_.useState)(optionMonth[0]);
...
var __webpack_exports__ = __webpack_require__.X(0, [225,719,149,722,26,484,338,111,378,740,442], () => (__webpack_exec__(4758)));
