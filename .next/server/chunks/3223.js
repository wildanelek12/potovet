...
__webpack_require__.d(__webpack_exports__, {
  uw: () => (/* binding */ CategoryScale),
  kL: () => (/* binding */ Chart),
  Gu: () => (/* binding */ index),
  De: () => (/* binding */ plugin_legend),
  ST: () => (/* binding */ LineController),
  jn: () => (/* binding */ LineElement),
  f$: () => (/* binding */ LinearScale),
  od: () => (/* binding */ PointElement),
  Dx: () => (/* binding */ plugin_title),
  u: () => (/* binding */ plugin_tooltip)
});

// UNUSED EXPORTS: Animation, Animations, ArcElement, BarController, BarElement, BasePlatform, BasicPlatform, BubbleController, Colors, DatasetController, Decimation, DomPlatform, DoughnutController, Element, Interaction, LogarithmicScale, PieController, PolarAreaController, RadarController, RadialLinearScale, Scale, ScatterController, SubTitle, Ticks, TimeScale, TimeSeriesScale, _adapters, _detectPlatform, animator, controllers, defaults, elements, layouts, plugins, registerables, registry, scales
...
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9127);
