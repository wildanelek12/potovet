	...
	return (
		<form className="flex flex-col w-full gap-6" {...formProps}>
			...
			<RichTextEditor
				...
				implementasikan.`}
				template = {'<ul><li><strong>- Deskripsi Produk :</strong></li><li><strong>&nbsp; </strong>( Contoh : POTOVET adalah website untuk mengembangkan dokumen hasil belajar yang dikenal dengan portofolio. Website ini di desain untuk lulusan sekolah tinggi bidang informatika di perguruan tinggi kejuruan. user dapat menggunakan potovet untuk berbagi portofolio kepada industri dan meletakkanya pada aplikasi digital atau sosial media.</li><li>&nbsp;POTOVET &nbsp;juga dapat menyimpan portofolio dalam bentuk susunan album dan menampilkan data profile user dengan interaktif.)</li></ul><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><ul><li><strong>- Definisi Masalah :</strong></li><li><strong>&nbsp; </strong>( Contoh : Seabagai lulusan sekolah kejuruan, user merasa kesulitan untuk mengorganisir hasil belajar yang dimiliki dan mengembangakanya menjadi sebuah dokumen narasi. Selain itu, user tidak mengetahui susunan atau tahapan isi pengembangan portofolio dan kesulitan untuk membuat narasi pada hasil belajar yang dimasukkan.)</li></ul><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p><strong>- Peranan dalam Pengembangan Produk :</strong></p><ul><li><strong>&nbsp; </strong>( Contoh : Produk ini dikembangakan dengan tim sebanyak 5 orang dan memiliki tugas yang dikerjakan berkaitan dengan bagian desain untuk mengembangkan Motion Prototype. Motion Prototype dikembangkan tool Framer.)</li></ul><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p><strong>- Implementasi Solusi :</strong></p><ul><li><strong>&nbsp;</strong>( Contoh : Langkah yang diterapkan untuk mengatasi definisi masalah adalah pengembangan website portofolio yang dilengkapi dengan tahapan pengembangan detail, bantuan penulisan narasi, dan link share digital.)</li></ul><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>'}
			/>
