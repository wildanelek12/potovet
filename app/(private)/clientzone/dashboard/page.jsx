  ...
  return (
    <React.Fragment>
      <div className="flex flex-row items-center col-span-full lg:col-12">
        <p className="flex-1 text-xl font-bold text-center text-primary">Dashboard</p>
        ...
        <div className="flex h-full">
          ...
          <div className="flex-1 p-8 ">
            <div className="grid gap-2 text-center place-items-center">
              ...
              <p className="text-base font-normal">{"Portfolio draft dan publish tersimpan otomatis dalam menu 'My Portofolio'"}</p>
            </div>
          </div>
        </div>
      </Card>
