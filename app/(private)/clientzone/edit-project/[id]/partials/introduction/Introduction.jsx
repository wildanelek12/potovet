...
export default function Introduction({ data }) {
	const { formData, setFormData, setInitialFormData, getIsFilledFormData } = useIntroductionStore()
	...
	return (
		<form className="flex flex-col w-full gap-6" {...formProps}>
			...
			{[2, 4].includes(formData.category_id) ? (
				<>
					...
					<FileInput
						...
						previewInitial={formData.preview_recommendation_letter}
			...
			<FileInput
				...
				previewClassName="w-full grid-cols-4"
				previewInitial={formData.preview_project_cover}
				preview
			/>
