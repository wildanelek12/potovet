...
export default function ProjectOverview() {
	...
	const optionJobRole = [
		...
		{ id: 3, name: 'Full Stack Developer', unavailable: false },
		{ id: 4, name: 'Game Developer', unavailable: false },
		{ id: 5, name: 'Software Development Engineer', unavailable: false },
		...
		<>
			<div className="grid gap-4 ">
				...
				<DatePickerComponent
					...
					onChange={(newValue) => setProject({ ...project, time_elapsed: newValue })}
				/>

				<Select
					options={optionJobRole}
					defaultValue={optionJobRole[0]}
					selected={project.job_role}
					onChange={(e) => setProject({ ...project, job_role: e })}
					label={'Job Role'}
				/>
				<FileInput
					label="Project Cover"
