...
import ProjectOverview from '../../add-project-draft/project-overview/form'
	...
	return (
		<>
			...
			<Card className="col-span-full p-8 h-fit border-none shadow-[0_6px_20px_rgba(154,154,154,0.25),0_-6px_20px_rgba(154,154,154,0.2)]">
				<ol className="flex items-center w-full mb-4 text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
