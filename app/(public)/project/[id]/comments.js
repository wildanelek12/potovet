    ...
    <>
      <Transition appear show={showModalComments} as={Fragment}>
        <Dialog
          ...
          onClose={() => setModalComments(false)}
        >
          <Transition.Child
            as={Fragment}
                  ...
                  >
                    <section class="bg-white dark:bg-gray-900 py-4 lg:py-4 antialiased">
                      <div class="w-full mx-auto px-2">
                        ...
                        <article class="p-2 mb-6 text-base bg-white rounded-lg dark:bg-gray-900">
                          ...
                          <p class="text-gray-500 dark:text-gray-400">
                            ...
                            instruments for the UX designers. The knowledge of
                            the design tools are as important as the creation of
                            the design strategy.
                          </p>
