  ...
  return (
    <nav className={"py-6 px-16 shadow-md flex items-center bg-white text-white"}>
      ...
      <div className="flex-row flex-1 space-x-12">
        <div className="relative inline-flex items-center hover:text-primary" onMouseEnter={handleFeaturesHover} onMouseLeave={handleFeaturesLeave}>
          <div className="text-base font-medium text-[#6E6F70] flex items-center hover:text-primary cursor-pointer">
            Features
          ...
          {isDropdownOpen && (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm font-normal">User dapat mengelola data yang berkaitan dengan informasi diri untuk menunjang pengembangan user.</span>
              </div>
              <div className="flex flex-col">
              ...
              <div>
                <Menu.Button className="inline-flex items-center justify-center w-full px-2 py-2 text-sm font-medium text-white rounded-md bg-secondary hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                  <Image
                    ...
                    src={user?.data?.photo ? `/${user?.data?.photo}` : "https://st3.depositphotos.com/1017228/18878/i/950/depositphotos_188781580-stock-photo-handsome-cheerful-young-man-standing.jpg"}
