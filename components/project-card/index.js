    ...
    <Link href={"/project/2"}>
      <div className="flex-col rounded-md">
        ...
        <div className="bg-[#0CADB7] rounded-b-lg p-4">
          ...
          <p className="mt-2 text-sm font-normal tracking-normal text-white">Website Perhitungan otomatis gaji karyawan yang .... Read More.</p>
          <div className="flex flex-row justify-between flex-1 mt-2 item-center">
            ...
            <div className="group relative">
              <span class="absolute  top-8 scale-0 rounded bg-gray-800 p-2 text-xs text-white group-hover:scale-100">Edit</span>
