            ...
            >
              <Dialog.Panel className="w-full max-w-lg p-6 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                <div className="flex flex-row ">
                  <Dialog.Title as="h3" className="flex flex-col items-center justify-center leading-6 text-gray-900 basis-1/2 ">
                  ...
                  <div className="flex flex-col basis-1/2 gap-y-4">
                    <div className="flex flex-row place-items-center">
                      ...
                      <p className="ml-2 text-sm font-medium">{props?.data?.instagram}</p>
                    </div>
                    <div className="flex flex-row place-items-center">
                      <Image width={30} height={30} src={"/logo-sosmed/linkedin.svg"} alt="" />
                      <p className="ml-2 text-sm font-medium">{props?.data?.linkedin}</p>
                    </div>
                    <div className="flex flex-row place-items-center">
                      <Image width={30} height={30} src={"/logo-sosmed/facebook.svg"} alt="" />
                      <p className="ml-2 text-sm font-medium">{props?.data?.facebook}</p>
                    </div>
                    <div className="flex flex-row place-items-center">
                      <Image width={30} height={30} src={"/logo-sosmed/email.svg"} alt="" />
                      <p className="ml-2 text-sm font-medium">{props?.data?.email}</p>
                    </div>
                  </div>
                </div>
